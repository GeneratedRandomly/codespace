...
class UCT
{
	...
	static int calculateProfit(const Board &opponentBoard, const Board &myBoard, const int rest, const int player);
...
public:
	...
	static Board nowOpponentBoard, nowMyBoard;
	static int *nowTop;
...
private:
	...
	const MoveResult getOptimalMove(Board &thatBoard, int opponentLastX, int opponentLastY);
